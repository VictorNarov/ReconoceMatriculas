function [cadenaReconocida,metricaSeparabilidad,iCaracteresParecidos] = Funcion_Reconoce_Matricula(Nombre, Numero_Objetos, verbose)
    ...
    [cadenaReconocida, metricaSeparabilidad,iCaracteresParecidos] = funcion_ReconoceCaracteres(Ietiq, Numero_Objetos);
